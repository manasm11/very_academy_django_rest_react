...
<head>
    ...
    <title>Coverage for dj3/lib/python3.8/site-packages/certifi/core.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>dj3/lib/python3.8/site-packages/certifi/core.py</b> :
...
<div id="source">
    ...
    <p id="t15" class="run"><span class="n"><a href="#t15">15</a></span><span class="t">    <span class="key">return</span> <span class="str">'/etc/ssl/certs/ca-certificates.crt'</span>&nbsp;</span><span class="r"></span></p>
</div>
<div id="footer">
    <div class="content">
        <p>
